...
@implementation LPPMenuBottomView
- (void)layoutSubviews{
...
- (void)createUI{
    ...
    self.previousChapter = ({
        CGRect frame = CGRectMake(0, kSpace_lpp_10, 55, 32);
        UIButton *previousChapter = [UIButton buttonWithType:UIButtonTypeCustom];
        previousChapter.frame = frame;
        previousChapter.titleLabel.font = FONT_SYSTEM_LPP_12;
    ...
    self.nextChapter = ({
        ...
        nextChapter.titleLabel.font = FONT_SYSTEM_LPP_12;
    ...
    // 进度条
    self.slider = ({
        CGFloat sliderX = CGRectGetMaxX(_previousChapter.frame) + kSpace_lpp_10;
