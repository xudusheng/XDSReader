...
- (void)createUI{
    ...
    self.typeLabel = ({
        ...
        CGRect frame = CGRectMake(CGRectGetWidth(self.frame) - typeLabelW - kSpace_lpp_15,
                                  (CGRectGetHeight(self.frame) - typeLabelH)/2,
                                  typeLabelW,
                                  typeLabelH);
        UILabel *label = [[UILabel alloc] initWithFrame:frame];
        label.text = @"系统";
        label.font = FONT_SYSTEM_LPP_10;
    ...
    self.slider = ({
        // 进度条
        CGFloat sliderX = CGRectGetMaxX(_titleLabel.frame) + kSpace_lpp_15;
        CGFloat sliderW = CGRectGetMinX(_typeLabel.frame) - kSpace_lpp_15 - sliderX;
        CGRect frame = CGRectMake(sliderX, 0, sliderW, CGRectGetHeight(self.frame));
        UISlider *slider = [[UISlider alloc] initWithFrame:frame];
        slider.minimumValue = 0.0;
        slider.maximumValue = 1.0;
        slider.tintColor = TEXT_COLOR_LPP_2;
